...
def prop_elliptical_obscuration(wf, xradius, yradius, xc = 0.0, yc = 0.0, **kwargs):
    ...
    ----------------
    NORM : bool
        If set to True, the specified radii and obscuration center are assumed to 
    ...
    wf.wfarr *= proper.prop_shift_center(proper.prop_ellipse(wf, xradius, yradius, xc, yc, DARK=True, ROTATION=rotation, NORM=norm))
