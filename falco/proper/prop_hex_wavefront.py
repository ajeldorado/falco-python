...
def prop_hex_wavefront(wf, nrings, hexrad, hexsep, zernike_val = 0, **kwargs):
    ...
    OMIT=omit
        List of segment IDs to omit drawing, starting with 0. "zernike_val", if 
        specified, must include entries for the omitted segments, but they are ignored.
    ...
    Original translation by Navtej Saini
    Revised 28 Oct 2019 - JEK - Fixed NO_APPLY and DARKCENTER logic to allow False setting
    31 Mar 2022 - JEK - added OMIT option and set default values for xc & yc
    2 May 2022 - JEK - fixed missing colons
    """
