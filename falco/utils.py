...
def _spec_arg(k,kwargs,v):
    """
    Specifiy a default argument for constructors of classes created from .mat files.
    ...
    kwargs
        kwargs parameters that ovetride default value
        If "mat_struct" is present, it will also override the value
