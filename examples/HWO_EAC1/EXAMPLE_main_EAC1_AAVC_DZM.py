...
# mp = falco.config.ModelParameters.from_yaml_file(os.path.join(HERE, 'config_dzm.yaml'))

import EXAMPLE_config_EAC1_AAVC_DZM as CONFIG
...
mp.est.dither = 0.015 #--std dev of dither command for random dither [V/sqtr(iter)]
