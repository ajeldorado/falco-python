...
mp.est.probe.yOffset = 0  # offset of probe center in y [lambda/D]. Use to avoid central obscurations.
...
mp.F3.compact.res = 4  # FPM sampling in compact model [pixels per lambda0/D]
mp.F3.full.res = 4  # FPM sampling in full model [pixels per lambda0/D]
