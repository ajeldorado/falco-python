...
fnLS = os.path.join(mp.full.data_dir, 'hlc_20200617c_band2', 'lyot.fits')
...
for si in range(mp.Nsbp):
    ...
    fn_p_r = os.path.join(mp.full.data_dir, ('hlc_20200617c_band2/hlc_jacobian_fpm_trans_%.8fum_real.fits' % lamUmVec[si]))
    fn_p_i = os.path.join(mp.full.data_dir, ('hlc_20200617c_band2/hlc_jacobian_fpm_trans_%.8fum_imag.fits' % lamUmVec[si]))
