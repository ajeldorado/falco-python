...
mp.Fend.res = mp.lambda0/(500e-9)*2  # Sampling [ pixels per lambda0/D]. 730/500*2
...
fn_dm1_design = os.path.join(flatmap_path, 'dm1_m_design_hlc_band2.fits')
fn_dm2_design = os.path.join(flatmap_path, 'dm2_m_design_hlc_band2.fits')
fn_dm1_flatmap = os.path.join(flatmap_path, 'dm1_m_flat_hlc_band2.fits')
fn_dm2_flatmap = os.path.join(flatmap_path, 'dm2_m_flat_hlc_band2.fits')
...
fnLS = os.path.join(mp.full.data_dir, 'hlc_20200614b_band3', 'lyot.fits')
...
for si in range(mp.Nsbp):
    ...
    fn_p_r = os.path.join(mp.full.data_dir, ('hlc_20200614b_band3/hlc_jacobian_fpm_trans_%.8fum_real.fits' % lamUmVec[si]))
    fn_p_i = os.path.join(mp.full.data_dir, ('hlc_20200614b_band3/hlc_jacobian_fpm_trans_%.8fum_imag.fits' % lamUmVec[si]))
