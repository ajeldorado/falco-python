...
mp.thput_eval_x = 7*falco.util.cosd(60)  # x location [lambda_c/D] in dark hole at which to evaluate throughput
mp.thput_eval_y = 7*falco.util.sind(60)  # y location [lambda_c/D] in dark hole at which to evaluate throughput

# Where to shift the source to compute the intensity normalization value.
mp.source_x_offset_norm = 7*falco.util.cosd(60)  # x location [lambda_c/D] in dark hole at which to compute intensity normalization
mp.source_y_offset_norm = 7*falco.util.sind(60)  # y location [lambda_c/D] in dark hole at which to compute intensity normalization
...
fn_dm1_flatmap = os.path.join(flatmap_path, 'dm1_m_spc-spec_rotated_band2.fits')
fn_dm2_flatmap = os.path.join(flatmap_path, 'dm2_m_spc-spec_rotated_band2.fits')
fn_dm1_flatmapNoSPM = os.path.join(flatmap_path, 'dm1_m_flat_hlc_band2.fits')
fn_dm2_flatmapNoSPM = os.path.join(flatmap_path, 'dm2_m_flat_hlc_band2.fits')
...
fnSP = os.path.join(mp.full.data_dir, 'spc_20200628_specrot', 'SPM_SPC-20200628_1000_derotated.fits')
...
fnLS = os.path.join(mp.full.data_dir, 'spc_20200628_specrot', 'LS_SPC-20200628_1000.fits')
...
fnFPM = os.path.join(mp.full.data_dir, 'spc_20200628_specrot', 'FPM_SPC-20200628_res20.fits')
